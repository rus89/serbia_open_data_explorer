// ABOUTME: Home (catalog) screen: search field, filters, and scrollable dataset list with load-more.
// ABOUTME: Uses datasetSearchParamsProvider and datasetSearchStateProvider; navigates to detail via AppRoutes.
...
/// Home screen: search, collapsible filters, and dataset list with pagination.
