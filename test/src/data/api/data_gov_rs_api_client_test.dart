...
void main() {
  ...
  group('searchDatasets', () {
    test('returns DatasetListResponse with data list and pagination', () async {
  ...
  group('getDatasetById', () {
    test('returns dataset with matching id when found', () async {
  ...
  group('error handling', () {
    test('getDatasetById throws on non-existent id', () async {
      expect(
